...
class PickerPlusRangeDaysPickerController extends GetxController {
  final PickerPlusRangeDaysPicker widget;
  late Rx<DateTime?> displayedMonth;
  late PageController pageController;

  PickerPlusRangeDaysPickerController(this.widget);

  @override
  void onInit() {
    super.onInit();
    final clampedInitailDate = PickerPlusDateUtilsX.clampDateToRange(
...
class PickerPlusRangeDaysPicker extends StatefulWidget {
  ...
  @override
  State<PickerPlusRangeDaysPicker> createState() => _RangeDaysPickerGetXState();
}

class _RangeDaysPickerGetXState extends State<PickerPlusRangeDaysPicker> {
  late final PickerPlusRangeDaysPickerController controller;
  final GlobalKey _pageViewKey = GlobalKey();

  @override
  void initState() {
    super.initState();
    controller = PickerPlusRangeDaysPickerController(widget);
    controller.onInit();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final splashColor = widget.splashColor ?? singleSelectedCellDecoration.color?.withOpacity(0.3) ?? colorScheme.primary.withOpacity(0.3);
    final highlightColor = widget.highlightColor ?? singleSelectedCellDecoration.color?.withOpacity(0.3) ?? colorScheme.primary.withOpacity(0.3);
